...
def plot_data(accuracies):
    ...
    plt.plot(x, Y[1], c='b', marker="o",
             fillstyle='none', label='RF Model Accurac')
    ...
    results = stats.f_oneway(
        accuracies[0][10], accuracies[0][20], accuracies[0][40], accuracies[0][50])
    results1 = stats.f_oneway(
        accuracies[1][10], accuracies[1][20], accuracies[1][40], accuracies[1][50])
