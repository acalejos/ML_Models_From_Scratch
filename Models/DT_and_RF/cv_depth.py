...
def plot_data(accuracies):
    ...
    plt.plot(x, Y[0], c='r', marker="o",
             fillstyle='none', label='DT Model Accuracy')
    plt.plot(x, Y[1], c='b', marker="o",
             fillstyle='none', label='BT Model Accuracy')
    plt.plot(x, Y[2], c='m', marker="o",
             fillstyle='none', label='RF Model Accuracy')
    ...
    results = stats.f_oneway(
        accuracies[0][3], accuracies[0][5], accuracies[0][7], accuracies[0][9])
    results1 = stats.f_oneway(
        accuracies[1][3], accuracies[1][5], accuracies[1][7], accuracies[1][9])
    results2 = stats.f_oneway(
        accuracies[2][3], accuracies[2][5], accuracies[2][7], accuracies[2][9])
